...
﻿namespace cdeNMI {
    ...
    export class TheDashboard extends TheNMIBaseControl implements cdeNMI.INMIDashboard {
        ...
        public SetupDashboard(pScreenID: string): INMIDashboard {
            ...
            if (tScreenInfo.MyDashboard["Title"] && tScreenInfo.MyDashboard["Title"].length > 0 && tScreenInfo.MyDashboard["Title"] !== "-HIDE") {
                    ...
                    default:
                        {
                            ...
                            let tForceLoad: boolean = cde.CBool(cde.CBool(cdeNMI.ThePB.GetValueFromBagByName(tDashPanels[i].PropertyBag, "ForceLoad")) || cdeNMI.ThePB.GetValueFromBagByName(tDashPanels[i].PropertyBag, "DefaultPortal") != null || (tPanelTitle.substring(tPanelTitle.length - 5) !== "-HIDE" && (cdeNMI.ThePB.GetValueFromBagByName(tDashPanels[i].PropertyBag, "HTMLUrl") !== null || cdeNMI.ThePB.GetValueFromBagByName(tDashPanels[i].PropertyBag, "HTML") !== null)));
