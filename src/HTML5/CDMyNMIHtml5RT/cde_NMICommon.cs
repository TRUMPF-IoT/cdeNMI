...
namespace NMIService
{
    public partial class TheNMIHtml5RT : ICDEPlugin, ICDEThing, ICDENMIPlugin
    {
        ...
        private void CreateUserFields(TheFormInfo tMyUserSettingsForm, bool IsAdmin)
        {
            ...
            var HomeScreenField = TheNMIEngine.AddSmartControl(MyBaseThing, tMyUserSettingsForm, eFieldType.ComboBox, 120, 2, 0, "Home Screen", "HomeScreen", new nmiCtrlComboBox() { TileHeight = 1, TileWidth = 6, ParentFld = 100, Options = "SCREENPICKER;Main Portal:%MAINDASHBOARD%;%GetNMIViews%" });
